...
public abstract class AbstractSocketConnecter extends Own implements IPollEvents
{
    ...
    public AbstractSocketConnecter(IOThread ioThread, SessionBase session, final Options options, final Address addr,
    ...
    public void connectEvent()
    {
        ...
        try {
            this.tuneConnectedChannel(channel);
        }
        catch (IOException e) {
    ...
    private boolean open() throws IOException
    {
        ...
        this.fd = this.openClient(resolved);
    ...
    protected abstract SocketChannel openClient(Address.IZAddress address) throws IOException;
