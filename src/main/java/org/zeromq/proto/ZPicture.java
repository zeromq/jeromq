...
public class ZPicture {
    ...
    /**
     * Creates a binary encoded 'picture' message to the socket (or actor), so it
     * can be sent.
     * The arguments are encoded in a binary format that is compatible with zproto,
     * and
     ...
     *                <th style="text-align:left">zproto type</th>
     *                </tr>
     *                <tr>
     *                <td>1</td>
     *                <td>int</td>
     *                <td>type = "number" size = "1"</td>
     *                </tr>
     *                <tr>
     *                <td>2</td>
     *                <td>int</td>
     *                <td>type = "number" size = "2"</td>
     *                </tr>
     *                <tr>
     *                <td>4</td>
     *                <td>long</td>
     *                <td>type = "number" size = "3"</td>
     *                </tr>
     *                <tr>
     *                <td>8</td>
     *                <td>long</td>
     *                <td>type = "number" size = "4"</td>
     *                </tr>
     *                <tr>
     *                <td>s</td>
     *                <td>String, 0-255 chars</td>
     *                <td>type = "string"</td>
     *                </tr>
     *                <tr>
     *                <td>S</td>
     *                <td>String, 0-2^32-1 chars</td>
     *                <td>type = "longstr"</td>
     *                </tr>
     *                <tr>
     *                <td>b</td>
     *                <td>byte[], 0-2^32-1 bytes</td>
     *                <td>type = "chunk"</td>
     *                </tr>
     *                <tr>
     *                <td>c</td>
     ...
     *                <td>m</td>
     *                <td>ZMsg</td>
     *                <td>type = "msg" <b>Has to be the last element of the
     *                picture</b></td>
     *                </tr>
     *                </table>
     * @param args    Arguments according to the picture
     * @return true when it has been queued on the socket and ØMQ has assumed
     *         responsibility for the message.
     *         This does not indicate that the message has been transmitted to the
     *         network.
    ...
    public ZMsg msgBinaryPicture(String picture, Object... args) {
        ...
        needle = encodeData(needle, picture, args);
        msg.addFirst(frame);
        return msg;
    }

    public ZNeedle encodeData(ZNeedle needle, String picture, Object... args) {
        for (int index = 0; index < picture.length(); index++) {
            char pattern = picture.charAt(index);
            switch (pattern) {
                case '1': {
     ...
     * This method is similar to {@link org.zeromq.ZMQ.Socket#recv()}, except the
     * arguments are encoded
     * in a binary format that is compatible with zproto, and is designed to
     * reduce memory allocations.
     *
     * @param picture The picture argument is a string that defines
     *                the type of each argument. See
     *                {@link #sendBinaryPicture(Socket, String, Object...)}
     ...
     *                <caption><strong>Types of arguments</strong></caption>
     *                <tr>
     *                <td>i = int (stores signed integer)</td>
     *                </tr>
     *                <tr>
     *                <td>1 = byte (stores 8-bit unsigned integer)</td>
     *                </tr>
     *                <tr>
     *                <td>2 = int (stores 16-bit unsigned integer)</td>
     *                </tr>
     *                <tr>
     *                <td>4 = long (stores 32-bit unsigned integer)</td>
     *                </tr>
     *                <tr>
     *                <td>8 = long (stores 64-bit unsigned integer)</td>
     *                </tr>
     *                <tr>
     *                <td>s = String</td>
     *                </tr>
     ...
     *                </tr>
     *                <tr>
     *                <td>m = ZMsg (sends all frames in the ZMsg)<b>Has to be the
     *                last element of the picture</b></td>
     *                </tr>
     *                <tr>
     *                <td>z = sends zero-sized frame (0 arguments)</td>
     *                </tr>
     *                </table>
     *                Note that s, b, f and m are encoded the same way and the
     *                choice is
     *                offered as a convenience to the sender, which may or may not
     *                already
     *                have data in a ZFrame or ZMsg. Does not change or take
     *                ownership of
     *                any arguments.
     *
     ...
     *                </tr>
     *                <tr>
     *                <td>1 = int (stores 8-bit unsigned integer)</td>
     *                </tr>
     *                <tr>
     *                <td>2 = int (stores 16-bit unsigned integer)</td>
     *                </tr>
     ...
     *                </tr>
     *                <tr>
     *                <td>f = ZFrame (creates zframe)</td>
     *                </tr>
     *                <tr>
     *                <td>m = ZMsg (creates a zmsg with the remaing frames)</td>
     *                </tr>
     *                <tr>
     *                <td>z = null, asserts empty frame (0 arguments)</td>
     *                </tr>
     *                </table>
     *
     *                Also see {@link #sendPicture(Socket, String, Object...)} how
     *                to send a
     *                multiframe picture.
     *
     * @return the picture elements as object array
