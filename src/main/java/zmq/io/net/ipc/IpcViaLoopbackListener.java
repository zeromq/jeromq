...
public class IpcViaLoopbackListener extends TcpListener
{
    public IpcViaLoopbackListener(IOThread ioThread, SocketBase socket, final Options options)
    {
    ...
    {
        var address = new IpcViaLoopbackAddress(addr);
