...
public abstract class AbstractSocketListener<A extends Address.IZAddress> extends Listener
{
    ...
    public AbstractSocketListener(IOThread ioThread, SocketBase socket, final Options options)
    {
    ...
    public void acceptEvent()
    {
        ...
        try {
            ...
            this.tuneAcceptedChannel(channel);
        }
        catch (IOException e) {
            //  If connection was reset by the peer in the meantime, just ignore it.
    ...
    protected boolean setZAddress(A address)
    {
        ...
        try {
            fd = this.openServer(address);
            this.bindServer(fd, address);
